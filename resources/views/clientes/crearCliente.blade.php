            ...
            <form action="{{route('clientess.store')}}" method="POST" >
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="cli_apellido" class="form-control" placeholder="Nombre">
                        @error('cli_apellidos')
                        <p class="alert alert-danger mt-2" role="alert">
                            {{ $message }}
                        </p>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="cli_telefono" class="form-control" placeholder="Nombre">
                        @error('cli_telefono')
                        <p class="alert alert-danger mt-2" role="alert">
                            {{ $message }}
                        </p>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" name="cli_correo" class="form-control" placeholder="Nombre">
                        @error('cli_correo')
                        <p class="alert alert-danger mt-2" role="alert">
                            {{ $message }}
                        </p>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="cli_notas" class="form-control" placeholder="Nombre">
                        @error('cli_notas')
                        <p class="alert alert-danger mt-2" role="alert">
                            {{ $message }}
                        </p>
