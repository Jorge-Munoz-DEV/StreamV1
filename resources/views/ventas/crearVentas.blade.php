                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="text" id="clienteSeleccionado" class="form-control" placeholder="Cliente" readonly>
                            <input type="hidden" name="tbl_Clientes_cli_id" id="clienteId" value="">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="ven_nombre_perfil" class="form-control" placeholder="Nombre del perfil">
                    ...
                    <div class="col-md-6">
                        ...
                        $fechaFormateada = $fechaActual->format('Y-m-d'); // Formato YYYY-MM-DD

                        echo '<label class="form-label">fecha actual:</label>';
                        echo '<input type="date" name="ven_fecha_compra" class="form-control" placeholder="nombre del perfil" value="' . $fechaFormateada . '">';
                        @endphp
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="ven_fecha_vence" class="form-control" placeholder="fecha de vencimiento">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="ven_precio" class="form-control" placeholder="Precio">
                        @error('ven_precio')
                            <p class="alert alert-danger mt-2" role="alert">
                                {{ $message }}
                            </p>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="ven_pin" class="form-control" placeholder="Pin">
                        @error('ven_pin')
                            <p class="alert alert-danger mt-2" role="alert">
                                {{ $message }}
                            </p>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="ven_notas" class="form-control" placeholder="Anotacion">
                        @error('ven_notas')
                            <p class="alert alert-danger mt-2" role="alert">
                                {{ $message }}
                            </p>
                    ...
                    <div class="col-md-6">
                        <input type="number" name="tbl_perfiles_per_id" class="form-control" placeholder="Perfil" value="{{ $perfiles->per_id }}" hidden>
